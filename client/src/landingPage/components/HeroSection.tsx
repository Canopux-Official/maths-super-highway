...
//                             }}
//                         >
//                             Learn Better. Score Higher. Excel at every examination
//                         </Typography>
...
//                     {/* Section wrapper - always rendered once loading starts, no sudden pop-in */}
//                     {/* Always mounted once we start loading, so no sudden pop-in */}
//                     <Box sx={{ position: "relative", mt: { xs: 5, md: 7 } }}>

//                         {/* Section label - always visible so layout doesn't jump */}
...
//                         {/* ── LOADING STATE ── */}
//                         {!resultsLoaded && (
//                             <Box sx={{ display: "flex", justifyContent: "center", px: { xs: 6, md: 7 } }}>
//                                 <Box
//                                     sx={{
//                                         width: { xs: "100%", md: "560px" },
//                                         height: { xs: "240px", sm: "340px", md: "340px" },
//                                         borderRadius: "16px",
//                                         position: "relative",
//                                         overflow: "hidden",
...
//                                             position: "absolute",
//                                             inset: 0,
//                                             background: "linear-gradient(90deg, rgba(6,182,212,0.04) 0%, rgba(6,182,212,0.14) 50%, rgba(6,182,212,0.04) 100%)",
//                                             backgroundSize: "200% 100%",
//                                             animation: "shimmerLoad 1.6s ease-in-out infinite",
...
//                                         <EmojiEventsIcon sx={{ color: "rgba(34,211,238,0.25)", fontSize: 48 }} />
//                                     </Box>
//                                 </Box>
//                             </Box>
//                         )}

//                         {/* ── EMPTY STATE (request finished, nothing to show) ── */}
...
//                             >
//                                 <Box sx={{ maxWidth: "560px", mx: "auto", px: { xs: 6, md: 7 } }}>
//                                     <Box
//                                         sx={{
//                                             borderRadius: "16px",
...
//                                         }}
//                                     >
//                                         <EmojiEventsIcon sx={{ color: "rgba(34,211,238,0.4)", fontSize: 40 }} />
//                                         <Typography sx={{ color: "#fff", fontWeight: 700, fontSize: "1.05rem", fontFamily: "'Sora', sans-serif" }}>
//                                             Results Coming Soon
//                                         </Typography>
//                                         <Typography sx={{ color: "rgba(255,255,255,0.55)", fontSize: "0.9rem", maxWidth: "380px" }}>
//                                             Our students' top scores and achievements will be showcased here shortly.
//                                         </Typography>
//                                     </Box>
//                                 </Box>
//                             </motion.div>
...
//                                         {/* ...your existing mobile carousel JSX, unchanged... */}
//                                     </Box>
//                                 ) : (
//                                     <>
//                                         {/* ...your existing desktop coverflow JSX, unchanged... */}
//                                     </>
//                                 )}
//                             </motion.div>
//                         )}
...
const Hero: React.FC = () => {
    ...
    useEffect(() => {
        axios
            ...
            .then((res) => {
                if (res.data.success) setResults(res.data.data);
                else console.warn("Results API returned success:false", res.data);
            })
            .catch((err) => {
                        ...
                        {hasResults && (
                            ...
                            >
                                {isMobile ? (
                                    ...
                                    /* ── DESKTOP: 3D Landscape Coverflow ── */
                                    <>
                                        <Box
                                            sx={{
                                                position: "relative",
